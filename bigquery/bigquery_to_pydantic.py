...
def pydantic_model_from_bq_schema(bq_schema_filename, output_filename):
    with open(bq_schema_filename, 'r') as json_file:
        ...
        with open(output_filename, 'w') as model_file:
            ...
            model_file.write("from typing import Optional\n")
            model_file.write("\n\n")
            model_file.write("class DiagnosticDataModel(BaseModel):\n")
...
if __name__ == "__main__":
    ...
    for opt, arg in opts:
        if opt in ("-i", "--input"):
            ...
            output_filename = arg
    pydantic_model_from_bq_schema(bq_schema_filename, output_filename)
